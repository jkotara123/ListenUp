class QuizManager:
    def __init__(
        self, menu_comm_channel, question_handler, piano_manager, max_listens
    ) -> None:
        ...
        self.listens = 0
        piano_manager.set_quiz_manager(self)
    ...
    def check_answer(self, note_name) -> None:
        self.piano_manager.disable()
