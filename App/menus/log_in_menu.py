...
class LogInMenu:
    def __init__(self, root: ctk.CTk, launch_immediately: bool = True):
    ...
    def __log_in(self) -> None:
        ...
        if self.database_manager.see_if_user_can_be_logged_in(username, password):
            ...
            self.menu_frame.pack_forget()
            introductory_menu = IntroductoryQuizMenu(
                root=self.menu_frame.winfo_toplevel(),
                launch_immediately=True,
    ...
    def __enter_as_guest(self) -> None:
        self.error_label.configure(text="")
        self.login_entry.delete(0, ctk.END)
        self.password_entry.delete(0, ctk.END)
        self.menu_frame.pack_forget()
    ...
    def __prepare_menu(self, root) -> None:
        ...
        enter_as_guest_button = ctk.CTkButton(
            master=menu_frame,
            text_color="black",
            font=(fontname, 14),
            text="Enter as guest",
