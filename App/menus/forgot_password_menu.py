...
class ForgotPasswordMenu:
    ...
    def __send_reset_code_mail(self) -> None:
        ...
        reset_code_length = 6
        self.reset_code = "".join(
            random.choices(reset_code_characters, k=reset_code_length)
        )
        ...
        if self.database_manager.see_if_username_exists(username):
            ...
            message = (
                ...
                f"Your reset password code is as follows: {self.reset_code}\n\n"
    ...
    def __prepare_menu(self, root) -> None:
        ...
        send_reset_code_button = ctk.CTkButton(
            master=pre_reset_menu_frame,
            text_color="black",
            font=(fontname, 14),
            fg_color="white",
        ...
        reset_code_button = ctk.CTkButton(
            master=pre_reset_menu_frame,
            text_color="black",
            corner_radius=8,
            fg_color="white",
            ...
            width=100,
            height=10,
            text="Apply reset code and reset password",
            hover_color="grey",
        ...
        go_back_button = ctk.CTkButton(
            ...
            text="Go back",
            corner_radius=8,
            command=self.__quit_reset_stage,
            border_width=2,
            border_color="black",
            hover_color="grey",
        )
