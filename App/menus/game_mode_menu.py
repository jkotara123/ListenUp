...
class GameModeMenu:
    ...
    def play_question(self, unused):
        ...
        def internal_play_question():
            try:
                ...
                play_image = ctk.CTkImage(light_image=Image.open(f"{images_path}/play_sound/play_sound_grey.png"),
    ...
    def __prepare_menu(self, root, octaves):
        ...
        menu_bg_image = Image.open(
            f"{images_path}/gm_background_.png")
        ...
        menu_bg_image_ = Image.open(
            f"{images_path}/gm_background_rev_.png")
        ...
        correct_ans_image = ctk.CTkImage(light_image=Image.open(
            f"{images_path}/white_tick_tbg.png"), size=(button_height//2, button_height//2))
        ...
        incorrect_ans_image = ctk.CTkImage(light_image=Image.open(
            f"{images_path}/white_cross_tbg.png"), size=(button_height//2, button_height//2))
